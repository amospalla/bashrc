...
vars["neomutt_Ubuntu_16.04_configure_command"]="./configure --prefix=/usr/local --sasl --notmuch --tokyocabinet --gss --gpgme --gnutls"
...
vars["neomutt_Ubuntu_18.04_packages_required"]="libc6 libgnutls30 libgpgme11 libgssapi-krb5-2 libidn11 libncursesw5 libnotmuch5 libsasl2-2 libtinfo5 libtokyocabinet9 mime-support"
vars["neomutt_Ubuntu_18.04_packages_dev"]="build-essential git gettext xsltproc libxml2-utils docbook-xml docbook-xsl libncursesw5-dev libidn11-dev libgnutls28-dev libkrb5-dev libtokyocabinet-dev libnotmuch-dev libgpgme-dev"
vars["neomutt_Ubuntu_18.04_git"]="https://github.com/neomutt/neomutt"
vars["neomutt_Ubuntu_18.04_url"]=""
vars["neomutt_Ubuntu_18.04_configure_command"]="./configure --prefix=/usr/local --sasl --notmuch --tokyocabinet --gss --gpgme --gnutls"
